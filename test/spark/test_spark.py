...
def postgres_dump(config, data_frame):
    ...
    mode = 'append'
    data_frame.write.jdbc(url=url, table="final_results_test",
...
if __name__ == "__main__":
    ...
    df_news = df_clean.select('GLOBALEVENTID', 'SQLDATE', 'MonthYear', 'Year', 'Actor1Code', 'Actor1Type1Code', 'ActionGeo_FullName',
                              'ActionGeo_CountryCode', 'ActionGeo_ADM1Code', 'Actor1Geo_CountryCode', 'GoldsteinScale', 'AvgTone')
